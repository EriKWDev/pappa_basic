...
{
  prtmsg("Type info to see a list of all available commands. \n\n");
  prtmsg("All commands may be abbrevated by . E g program 2000 is eqv. p.2000\n");
  prtmsg("All end addresses should be one extra.\n");
  prtmsg("    Save 8000 0 AX7 saves file AX7 from 8000 to FFFF\n");
  prtmsg("Load <address> filename will load file to RAM\n");
  prtmsg("All commands with addresses have syntax start, end, to\n");
  prtmsg("\nGood luck !\n");
}
